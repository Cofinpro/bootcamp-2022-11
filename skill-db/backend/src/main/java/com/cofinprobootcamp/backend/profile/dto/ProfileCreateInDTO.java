...
public record ProfileCreateInDTO(
        ...
        @NotBlank(message = "Field degree can not be left blank!") String degree,
        @NotNull(message = "Field Expertise can not be left blank!") String primaryExpertise,
        @NotNull(message = "Reference text can not be left blank!") String referenceText,
        @NotEmpty(message = "Skill List can not be left blank") List<@NotBlank(message = "Entry in skill list can not be blank") String> skills,
        @NotBlank(message = "Phone number can not be left blank") @Pattern(regexp = Regex.VALID_PHONE_NUMBER, message = "Phone number has to be in a valid format") String phoneNumber,
